        ...
        <div class="bg-white p-3 shadow-lg flex flex-col items-center w-48">
            ...
            <a href="https://legaldata.mn/book/view/370">
                <img src="https://legaldata.mn/storage/pictures/2780/01JHHDTA9PHDC7582DGBPHZ1R3.png"
                    alt="Эрүүгийн эрх зүйн хууль ёсны зарчим" class="object-cover rounded-md w-full h-32 mb-3">
            </a>
            <div class="text-center">
                <h3 class="text-sm font-semibold mb-2">
                    <a href="https://legaldata.mn/book/view/370">
                        Эрүүгийн эрх зүйн хууль ёсны зарчим /Онол, философи/
                    </a>
                </h3>
                <p class="text-gray-600 text-xs">Б.Мөнх-Эрдэнэ</p>
                <p class="text-red-600 font-bold mt-2 text-sm">40,000₮</p>
