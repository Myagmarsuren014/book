            ...
            <div class="flex flex-col md:flex-row gap-6 ">
                ...
                <div class="max-w-lg">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <button class="bg-green-500 text-white text-xs px-4 py-2 rounded hover:bg-green-600">САГСАНД
                            НЭМЭХ</button>
                        <button class="bg-green-500 text-white text-xs px-4 py-2 rounded hover:bg-green-600">ХУДАЛДАЖ
                            АВАХ</button>
                    </div>
